              ...
              <div className="border border-slate-200 rounded-xl overflow-hidden">
                <table className="w-full text-sm">
                  <thead className="bg-slate-50">
                    <tr>
                      <th className="px-3 py-2 text-left text-slate-500">Producto</th>
                      <th className="px-3 py-2 text-center text-slate-500">Cantidad</th>
                      <th className="px-3 py-2 text-right text-slate-500">Precio unit.</th>
                      <th className="px-3 py-2 text-right text-slate-500">Subtotal</th>
                      ...
                      <tr key={i} className="border-t border-slate-100 hover:bg-indigo-50/30">
                        ...
                        <td className="px-3 py-2 text-center">
                          <input
                            ...
                            className="w-16 text-center border border-slate-200 rounded p-1 text-slate-600"
                          />
                        </td>
                        <td className="px-3 py-2 text-right">
                          <input
                            ...
                            className="w-24 text-right border border-slate-200 rounded p-1 text-slate-600"
                          />
                        </td>
                        ...
                        <td className="px-3 py-2 text-center">
                          <button onClick={() => eliminarProducto(i)} className="text-rose-500 hover:bg-rose-100 p-1 rounded">
                            <Trash2 size={14} />
                          </button>
                        </td>
                      </tr>
        ...
        <div className="px-6 py-4 border-t border-slate-100 bg-slate-50/50 flex justify-between items-center">
          ...
          <div className="flex gap-2">
            <button
              onClick={() => { reset(); onClose() }}
              disabled={cargando}
              className="px-5 py-2 border border-slate-200 rounded-xl text-sm font-medium text-slate-600 bg-white hover:bg-slate-50 transition-colors"
            >
              Cancelar
            </button>
            <button
