...
export default function Auditoria() {
  ...
  return (
    <div className="flex-1 bg-gray-50 p-4 sm:p-6 lg:p-8 overflow-auto">
      ...
      {cargando ? (
        ...
        <div className="bg-white rounded-2xl border border-gray-200 shadow-sm overflow-hidden">
            ...
            <table className="w-full text-sm border-collapse min-w-[700px]">
              <thead>
                <tr className="bg-slate-50">
                  <th className="px-3 sm:px-4 py-2 sm:py-3 text-left text-xs text-slate-500 uppercase whitespace-nowrap">ID</th>
                  <th className="px-3 sm:px-4 py-2 sm:py-3 text-left text-xs text-slate-500 uppercase whitespace-nowrap">Usuario</th>
                  <th className="px-3 sm:px-4 py-2 sm:py-3 text-left text-xs text-slate-500 uppercase whitespace-nowrap">Acción</th>
                  <th className="px-3 sm:px-4 py-2 sm:py-3 text-left text-xs text-slate-500 uppercase whitespace-nowrap">Tabla</th>
                  <th className="px-3 sm:px-4 py-2 sm:py-3 text-left text-xs text-slate-500 uppercase whitespace-nowrap">Descripción</th>
                  <th className="px-3 sm:px-4 py-2 sm:py-3 text-left text-xs text-slate-500 uppercase whitespace-nowrap">Fecha</th>
                </tr>
              </thead>
              <tbody>
                  ...
                  registrosFiltrados.map(registro => {
                    ...
                    return (
                      <tr key={registro.id} className="border-t border-gray-100 hover:bg-gray-50/50 transition-colors">
                        <td className="px-3 sm:px-4 py-2 sm:py-3 font-medium text-indigo-600 text-xs sm:text-sm whitespace-nowrap">
                          #{registro.id}
                        </td>
                        <td className="px-3 sm:px-4 py-2 sm:py-3 text-gray-700 text-xs sm:text-sm whitespace-nowrap">
                        ...
                        <td className="px-3 sm:px-4 py-2 sm:py-3 text-gray-600 text-xs sm:text-sm whitespace-nowrap">
                          <span className="inline-flex items-center gap-1">
                            <Tag size={12} className="text-gray-400" />
                            {registro.tabla_afectada}
                          </span>
                        </td>
                        <td className="px-3 sm:px-4 py-2 sm:py-3 text-gray-600 text-xs sm:text-sm max-w-[200px] sm:max-w-[300px] truncate">
                          {registro.descripcion}
                        </td>
                        <td className="px-3 sm:px-4 py-2 sm:py-3 text-gray-500 text-xs sm:text-sm whitespace-nowrap">
          ...
          {/* Paginación */}
          <div className="px-4 sm:px-6 py-3 sm:py-4 border-t border-gray-100 flex flex-col sm:flex-row justify-between items-center gap-3 text-sm text-gray-500">
            ...
            {totalPaginas > 1 && (
              <div className="flex gap-1">
                ...
                <span className="px-2 sm:px-3 py-1 text-xs sm:text-sm">{pagina} / {totalPaginas}</span>
                <button
                  onClick={() => fetchAuditoria(pagina + 1)}
